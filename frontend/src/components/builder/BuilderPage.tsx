    ...
    <Card title="Personal Information">
      <div className="grid gap-3 sm:grid-cols-2">
        ...
        <Field
          ...
          onChange={(v) => update("personal.role", v)}
        />
        <Field
          label="Email"
    ...
    >
      ...
      {sectionKey === "certifications" && (
        <NamedList
          ...
          update={(i) => update("certifications", i)}
          placeholder="Certification name"
          detailPlaceholder="Issuer / year"
        />
      )}
      {sectionKey === "languages" && (
        <NamedList
          items={resume.languages}
          update={(i) => update("languages", i)}
          placeholder="Language"
          detailPlaceholder="Level"
        />
      )}
      {sectionKey === "achievements" && (
        <NamedList
          items={resume.achievements}
          update={(i) => update("achievements", i)}
          placeholder="Achievement"
          detailPlaceholder="Details"
          aiLabel="Generate ideas"
          onAi={async () => {
            const res = await aiService.summary({
              role: resume.personal.role,
    ...
    <div className="space-y-3">
          ...
          >
            <div className="grid gap-2 sm:grid-cols-2">
              ...
              <Input
                ...
                onChange={(e) => {
                  const n = [...items];
                  n[i] = { ...it, location: e.target.value };
                  set(n);
                }}
              />
            ...
            <Textarea
              ...
              onChange={(e) => {
                const n = [...items];
                n[i] = { ...it, description: e.target.value };
                set(n);
              }}
            />
            <div className="mt-2 flex justify-between">
              <Button
                ...
                onClick={async () => {
                  try {
                    const res = await aiService.projects({
                      name: it.role,
                      tech: it.company,
                      description: it.description,
                    });
                    const n = [...items];
                    n[i] = { ...it, description: res.text };
                    set(n);
      ...
      <Button
        ...
        onClick={() =>
          set([
            ...items,
            { id: uid(), company: "", role: "", location: "", start: "", end: "", description: "" },
          ])
        }
      >
  ...
  return (
    <div className="space-y-3">
      ...
      <Button
        ...
        className="w-full gap-2"
        onClick={() =>
          set([...items, { id: uid(), name: "", link: "", tech: "", description: "" }])
        }
      >
  ...
  return (
    <div className="space-y-3">
      ...
      <Button
        ...
        className="w-full gap-2"
        onClick={() =>
          set([...items, { id: uid(), school: "", degree: "", field: "", start: "", end: "" }])
        }
      >
        ...
        {items.map((it, i) => (
          ...
          >
            ...
            <Button
              variant="ghost"
              size="icon"
              onClick={() => update(items.filter((_, x) => x !== i))}
            >
